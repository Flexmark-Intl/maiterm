                    ...
                    "updates": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "title": { "type": "string" },
                                "detail": { "type": "string", "description": "REPLACES the body — this is the spec (acceptance criteria, links, what done means). To record what happened, use `note` instead; rewriting detail to log progress destroys the spec." },
                                "note": { "type": "string", "description": "One line APPENDED to the task's progress log — why it is blocked, what you found, what you tried. Never replaces detail. This is where a Blocked row explains itself; without it the board shows a task stuck with no reason on it. Newest 20 kept." },
