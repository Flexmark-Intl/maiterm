...
<CardGrid>
  <Card title="Live transcripts" icon="comment-alt">
    Each agent streams per turn as a distilled chat — with its model, reasoning effort, a live context-window gauge, and compaction shown as a divider in the thread. Its tasks and background shells stream alongside it. Fast even on hundred-tab windows and sessions hundreds of megabytes long.
  </Card>
