...
### Themes
- **15 built-in themes** — Tokyo Night (default), Dracula, Solarized Dark, Solarized Light, Tokyo Night Day, Catppuccin Latte, Gruvbox Light, One Light, GitHub Light, Nord, Gruvbox Dark, Monokai, Catppuccin Mocha, One Dark, macOS Pro
...
Default: Tokyo Night. 15 built-in themes + custom theme support.
